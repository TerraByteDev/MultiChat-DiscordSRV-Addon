...
package com.loohp.multichatdiscordsrvaddon.libs;
...
public abstract class URLClassLoaderAccess {
    ...
    private static void throwError(Throwable cause) throws UnsupportedOperationException {
        throw new UnsupportedOperationException("MultiChatDiscordSrvAddon is unable to inject into the plugin URLClassLoader.\n" +
