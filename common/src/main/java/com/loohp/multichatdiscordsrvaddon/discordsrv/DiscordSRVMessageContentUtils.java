...
public class DiscordSRVMessageContentUtils {
    ...
    public RestAction<List<Message>> toJDAMessageRestAction(DiscordMessageContent content, TextChannel channel) {
    ...
    public ValuePairs<List<MessageEmbed>, Set<String>> toJDAMessageEmbeds(DiscordMessageContent content) {
